...
class CMD:
    ...
    def _tpl_handler(self, k: str, v: str):
        for c, h in [
            ...
            (True, self._tpl_template_handler),
            (True, self._tpl_db_handler),
